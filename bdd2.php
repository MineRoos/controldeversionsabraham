...
class BDD {
	...
	private function enviar_correu_usuari($correu = '', $codi = ''){
		...
		$mensaje.= "<br /><br /><a href='http://learneverywhere.cat/dawusuaris/activar_usuari_web.php?codi=".$codi."'>Activar compte usuari</a>";
        $mensaje.= "<hr>";
        ...
        $cabeceras .= "From: learneverywhere@learneverywhere.cat\n";
        $cabeceras .= "To: ".$correu."\n";
