...
if(isset($_REQUEST["metode"])){
		if($_REQUEST['metode']=="bbdd"){
			
		}
		else if($_REQUEST['metode']=="ldap"){
...
if(isset($_POST['login'])) {
	...
	if($user !== null && $pass !== null && $_REQUEST['metode']=="bbdd") {
	...
	else if($user !== null && $pass !== null && $_REQUEST['metode']=="ldap") {
			...
			<table>
				...
				<tr>
					<td colspan="2" align="center"><br/>
						<label for="metode">Mètode d'autenticació</label><br/>
						<input type="radio" name="metode" value="bbdd" checked>BBDD<br/>
  						<input type="radio" name="metode" value="ldap">LDAP<br/>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center"><br/>
